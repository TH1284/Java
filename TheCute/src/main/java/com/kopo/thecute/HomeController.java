...
public class HomeController {
	...
	public String showChart(Locale locale, Model model, @RequestParam("jobgroup") String jobgroup,@RequestParam("q010000") String q010000, @RequestParam("q07grade") String q07grade) {
...
//		System.out.println(selectData);
		...
		model.addAttribute("q010000_"  + jobgroup, "selected");
		model.addAttribute("q07grade_"  + jobgroup, "selected");
