  ...
  <div id="wrap">
    <div class="top_button_section">
      <form action="do_battle">
        <input type="text" name="select1" value="${idx1}"/>
        <input type="text" name="select2" value="${idx2}"/>
